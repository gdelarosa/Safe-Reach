...
class SocialVC: UITableViewController {
    ...
    let titleList = ["Bienestar Human Services Coachella",
                     "Bienestar Human Services El Monte",
                     "Bienestar Human Services Hollywood",
                     "Bienestar Human Services Long Beach",
                     "Bienestar Human Services East Los Angeles",
                     "Bienestar Human Services Pomona",
                     "Bienestar Human Services San Fernando Valley",
                     "Bienestar Human Services South Los Angeles",
